...
Current Instruction : {} \n ".format(
    ...
    [scr[0].name for scr in game.script_tree], game.script_tree[-1][0].name if game.script_tree != [] else None, game.script_tree[-1][0].contents[game.script_tree[-1][1]-1] if game.script_tree != [] else None)
